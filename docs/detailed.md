...
Generated workflows default to `LORE_CLI_VERSION=v0.1.5` and
...
LORE_WORKSPACE_TOKEN=... \
  pnpm test:deployment-smoke -- --expected-version 0.1.5
```
...
release `v0.1.5` provides checksum-verified macOS and Linux binaries. The
...
- Standalone macOS and Linux binaries are available in GitHub release `v0.1.5`.
