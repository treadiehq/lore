...
import type { MemoryStatus } from "@lore-co/sdk";
import { statusLabel } from "~/utils/memory";
...
<template>
  <span
    class="inline-flex w-fit items-center rounded-md border px-2 py-0.5 text-xs font-medium"
